...
func _process(_delta: float) -> void:
	...
	$infolbls/breath_accuracy_gap_left.text = "breath accuracy gap time left: " + str($Timers/breath_accuracy_cap.time_left)
	$infolbls/breath_interval_left.text = "breath interval time left: " + str($Timers/breath_interval.time_left)
